...
# Function that will get Fintech Finders candidates information
def get_people():
...
##########################################
def display_balance():
    st.sidebar.write(get_blance(w3, account.address))
...
# Calculate wage that will be paide based upon entered information
wage = candidate_database[person][3] * hours

# Write the 'wage' calculation to the streamlit sidebar 
st.sidebar.markdown("## Total wage in Either")
...
if st.sidebar.button("Send Transaction"):
    # Send transaction using send_transaction frunction (from imported python)
